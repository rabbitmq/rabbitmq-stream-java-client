...
public class SimpleMessageBuilder implements MessageBuilder {
    ...
    public Message build() {
        return new SimpleMessage(
                body,
                this.messageAnnotationsBuilder == null ? null : this.messageAnnotationsBuilder.messageAnnotations,
                this.propertiesBuilder == null ? null : this.propertiesBuilder.properties,
                this.applicationPropertiesBuilder == null ? null : this.applicationPropertiesBuilder.applicationProperties
        );
    }
    ...
    private static class SimpleMessage implements Message {
        ...
        private SimpleMessage(Object body, Map<String, Object> messageAnnotations, Properties properties, Map<String, Object> applicationProperties) {
            this.body = body;
