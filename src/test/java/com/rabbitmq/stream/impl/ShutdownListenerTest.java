...
public class ShutdownListenerTest {
    ...
    void shutdownListenerShouldBeCalledOnClientClosing() {
        ...
        Client client = new Client(new Client.ClientParameters()
                .shutdownListener(shutdownContext -> reason.set(shutdownContext.getShutdownReason())));
        client.close();
        assertThat(reason.get()).isNotNull().isEqualTo(Client.ShutdownContext.ShutdownReason.CLIENT_CLOSE);
    ...
    void shutdownListenerShouldBeCalledOnServerClosing() throws Exception {
        ...
        assertThat(reason.get()).isNotNull().isEqualTo(Client.ShutdownContext.ShutdownReason.SERVER_CLOSE);
        assertThat(client.isOpen()).isFalse();
    }
