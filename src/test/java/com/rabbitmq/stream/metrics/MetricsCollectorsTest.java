...
public class MetricsCollectorsTest {
    ...
    void micrometer() {
        ...
        assertThat(registry.get("rabbitmq.stream.outstanding_publish_confirm").gauge().value()).isEqualTo(10.0);
        collector.publishConfirm(5);
        assertThat(registry.get("rabbitmq.stream.confirmed").counter().count()).isEqualTo(5.0);
        assertThat(registry.get("rabbitmq.stream.outstanding_publish_confirm").gauge().value()).isEqualTo(5.0);
        collector.publishError(5);
        assertThat(registry.get("rabbitmq.stream.errored").counter().count()).isEqualTo(5.0);
        assertThat(registry.get("rabbitmq.stream.outstanding_publish_confirm").gauge().value()).isEqualTo(0);
    ...
    void dropwizard() {
        ...
        assertThat(registry.counter("rabbitmq.stream.outstanding_publish_confirm").getCount()).isEqualTo(10);
        collector.publishConfirm(5);
        assertThat(registry.meter("rabbitmq.stream.confirmed").getCount()).isEqualTo(5);
        assertThat(registry.counter("rabbitmq.stream.outstanding_publish_confirm").getCount()).isEqualTo(5);
        collector.publishError(5);
        assertThat(registry.meter("rabbitmq.stream.errored").getCount()).isEqualTo(5);
        assertThat(registry.counter("rabbitmq.stream.outstanding_publish_confirm").getCount()).isEqualTo(0);

        collector.chunk(100);
        assertThat(registry.meter("rabbitmq.stream.chunk").getCount()).isEqualTo(1);
        assertThat(registry.histogram("rabbitmq.stream.chunk_size").getSnapshot().getMax()).isEqualTo(100);
    }
