...
public class HttpTokenRequesterTest {
  ...
  @ParameterizedTest
  @ValueSource(booleans = {true, false})
  void requestTokenWithUrlConnection(boolean tls) throws Exception {
    String protocol;
    KeyStore keyStore;
  ...
  @Test
  void urlConnectionConstructorValidation() {
    assertThatThrownBy(
            () ->
                new HttpTokenRequester(null, "client", "secret", "grant", Map.of(), null, s -> null))
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessageContaining("tokenEndpointUri");

    assertThatThrownBy(
            () ->
                new HttpTokenRequester(
                    "http://localhost", "client", "secret", "grant", Map.of(), null, null))
        .isInstanceOf(IllegalArgumentException.class)
    ...
    assertThatThrownBy(
            () ->
                new HttpTokenRequester(
                    "not a valid uri", "client", "secret", "grant", Map.of(), null, s -> null))
        .isInstanceOf(IllegalArgumentException.class)
    ...
    HttpTokenRequester requester =
        new HttpTokenRequester(
            "http://localhost", "client", "secret", "grant", null, null, s -> null);
    assertThat(requester).isNotNull();
  }

  @Test
  void httpClientConstructorValidation() {
    assertThatThrownBy(
            () ->
                new HttpTokenRequester(
                    null, "client", "secret", "grant", Map.of(), b -> {}, null, s -> null))
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessageContaining("tokenEndpointUri");
    ...
    assertThatThrownBy(
            () ->
                new HttpTokenRequester(
                    "http://localhost", "client", "secret", "grant", Map.of(), b -> {}, null, null))
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessageContaining("parser");
    ...
    assertThatThrownBy(
            () ->
                new HttpTokenRequester(
                    "not a valid uri", "client", "secret", "grant", Map.of(), b -> {}, null, s -> null))
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessageContaining("Invalid URI");
    ...
    HttpTokenRequester requester =
        new HttpTokenRequester(
            "http://localhost", "client", "secret", "grant", null, b -> {}, null, s -> null);
    assertThat(requester).isNotNull();
  }
