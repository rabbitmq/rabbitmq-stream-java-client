...
public class StreamPerfTestTest {
        ...
        new HashMap<String, Client.StreamMetadata>() {
          {
            put(
                ...
                new Client.StreamMetadata(
                    ...
                    Arrays.asList(
                        new Client.Broker("broker3", 5555), new Client.Broker("broker2", 5555))));
            put(
                "stream2",
                new Client.StreamMetadata(
                    "stream2",
                    ...
                    Arrays.asList(
                        new Client.Broker("broker3", 5555), new Client.Broker("broker1", 5555))));
            put(
                "stream3",
                new Client.StreamMetadata(
                    "stream2",
                    ...
                    Arrays.asList(
                        new Client.Broker("broker2", 5555), new Client.Broker("broker1", 5555))));
          }
        });
  }
  ...
  void roundRobinAddressLocator() {
    StreamPerfTest.BrokerLocator locator =
        new StreamPerfTest.RoundRobinAddressLocator(
            Arrays.asList(
  ...
  void roundRobinReplicaBrokerLocator() {
    StreamPerfTest.BrokerLocator locator =
        new StreamPerfTest.RoundRobinReplicaBrokerLocator(topology());
