...
[[producer-sub-entry-size-configuration-entry]]
|`subEntrySize`
...
--------
<1> Set a name for the producer
<2> Query last publishing ID for this producer and increment it
<3> Scroll to the content for the next publishing ID
<4> Set the message publishing
