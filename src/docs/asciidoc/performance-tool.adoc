...
NOTE: Instance synchronization is compatible with https://perftest-dev.rabbitmq.com/#instance-synchronization[PerfTest], the AMQP 0.9.1 performance tool for RabbitMQ.
