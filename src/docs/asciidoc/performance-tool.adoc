...
docker run -it --rm --network stream-perf-test pivotalrabbitmq/stream-perf-test \
    --uris rabbitmq-stream://rabbitmq:5555
----
...
----
wget https://dl.bintray.com/rabbitmq/java-tools-dev/stream-perf-test/latest/stream-perf-test-latest.jar
----
...
https://dl.bintray.com/rabbitmq/java-tools-dev/stream-perf-test/latest/stream-perf-test-latest_completion[completion script]. You can download it and enable it in
your `~/.zshrc` file:
